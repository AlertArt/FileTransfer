...
public sealed class NullPlatformKeepAliveService : IPlatformKeepAliveService
{
    ...
    public void UpdateKeepAlive(string title, string content, double? progress, string? fileId) { /* no-op */ }
    public void StopKeepAlive() { /* no-op */ }
    public void ShowStatusNotification(string title, string content, string? openPath) { /* no-op */ }
}
